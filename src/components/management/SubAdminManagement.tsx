  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Sub-Admin Management</h1>
          <p className="text-gray-600 mt-1">Manage sub-admin accounts and their permissions</p>
        </div>
        
        <motion.button
          onClick={() => {
            setEditingUser({ role: 'sub-admin' }); // Pre-set role
            setShowForm(true);
          }}
        ...
        <div className="divide-y divide-gray-200">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-[#E08D40] rounded-full flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      title={user.isActive ? 'Deactivate Sub-Admin' : 'Activate Sub-Admin'}
                    >
          ...
          {filteredSubAdmins.length === 0 && (
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">No sub-admins found</h3>
